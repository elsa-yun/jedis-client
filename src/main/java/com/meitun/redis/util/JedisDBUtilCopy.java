...
//	}
//
//	private JedisSentinelPool getMasterJedisPool(String key) {
//		key = this.getCompleteKey(key);
//		int intKey = strToInt(key);
//		return this.getDbMasterShardJedisPool().getJedisPool(intKey);
//	}
//
//	private JedisSentinelPool getSlaveJedisPool(String key) {// 先从 从库池拿，没有再从主库池中拿
//		key = this.getCompleteKey(key);
//		int intKey = strToInt(key);
...
//		}
//		Jedis jds = null;
//		JedisSentinelPool masterJedisPool = getMasterJedisPool(key);
